                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-2">
                                    ...
                                    <div class="card-header bg-success text-white">
                                        <h4 class="font-weight-light mb-2 mt-2">Reset Password</h4>
                                    ...
                                    <div class="card-body mb-3">
                                        ...
                                        <form method="post" role="form" name="registration_form" action="<?php echo $request->getUri()->getPath();  ?>">
                                                ...
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <?php } ?>
                                                    <input type="password" name="password" class="form-control" id="inputpassword" value="<?= set_value('password') ?>"  placeholder="Password" required />
