...
<html lang="en">
    <head>
        ...
        <title>CLSU HRIS v2</title>
        <link href="<?= base_url('public/assets/simple-datatables/style.min.css') ?>" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="index.html" style="height:100%;">
				<img src="<?= base_url('public/assets/images/clsu_logo.png'); ?>" style="height:100%;">
				HRMIS v2
			</a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; CLSU-MISO 2024</div>
                            <!--<div>
