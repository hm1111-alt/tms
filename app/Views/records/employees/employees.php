...
<?= $this->section('header_actions') ?>
    <div class="mt-4">
            <ul class="page_title_button" style="list-style: none; float:right;">
                    <li style="">
                        <a href="<?php echo site_url('employees/add'); ?>" class="btn btn-light text-success"  role="button" style="">
        ...
        <div class="card mb-4" style="border-top: 0px;">
                <div class="card-body">
                        ...
                        <div class="datatable-top">
                                ...
                                <input type="hidden" id="order_by"  value="<?php echo session()->get('employees_order_by') ? session()->get('employees_order_by') : 'emp_lname'; ?>">
                                <input type="hidden" id="sort_by"  value="<?php echo session()->get('employees_sort_by') ? session()->get('employees_sort_by') : 'asc'; ?>">

                                <div class="datatable-search">
                                    <input name='search_event_list' id='search_event_list' class="datatable-input search <?php echo session()->get('employees_search') ? 'notempty' : ''; ?>" 
                                           value="<?php echo session()->get('employees_search') ? session()->get('employees_search') : ''; ?>"
...
<?= $this->section('footer_jscript') ?>
        ...
        <script type="text/javascript">
                $(document).ready(function(){
                        ...
                        load_table_url = '<?php echo site_url('employees/get_employees') ?>';
